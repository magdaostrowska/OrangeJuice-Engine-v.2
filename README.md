...
Forked from Ragnar Engine created by [Lucas Pérez](https://github.com/LucasPG14). and [Oriol Bernal](https://github.com/UriKurae).
...
To install just go into the [releases tab](https://github.com/magdaostrowska/OrangeJuice-Engine-v.2/releases), and download the latest version.
...
- Own file formats, hidden in the Engine's background.
  ...
  - The scenes are saved as .orangeJuice.
...
**Copyright (c) Jan Adell Mill, Oscar Reguera Parera and Magdalena Ostrowska. License Under the MIT License.**
